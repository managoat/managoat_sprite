...
The CLI is an optional interface to the Sprite service for terminal workflows
and scripts. For the desktop app, start with the [Manasprites README](../README.md).
...
[configuration reference](provisioning.md). Already have a Sprite?
[Install the service directly](manual-install.md).
...
app. See the [CLI and HTTP walkthroughs](conversations.md).
...
- [Provisioning](provisioning.md): repositories, environment, bootstrap, and retries.
- [Conversations](conversations.md): CLI commands, HTTP examples, and streaming.
- [Operations](guide.md): configuration, service management, backups, and upgrades.
- [API specification](spec.md#http-contract) · [OpenAPI](../priv/openapi.json).
- [Development](development.md): tests and release builds.
- [Acceptance record](acceptance.md): verified behavior and remaining work.
